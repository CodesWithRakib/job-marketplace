...
export default function RecruiterLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="flex h-screen bg-gradient-to-br from-green-50 to-emerald-50 dark:from-slate-900 dark:to-slate-800">
      {/* Mobile backdrop */}
      {sidebarOpen && (
        <div
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-4 md:p-6 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-slate-900 dark:to-slate-800">
